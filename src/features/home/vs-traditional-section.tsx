    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-6 max-w-2xl mx-auto">
        ...
        <h2 className="section-title mx-auto">
          Stop Wasting <span className="text-primary relative">Hundreds of Dollars</span>
        </h2>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-4 text-center">
          <Button size="xl" className="hover:shadow-glowing-lg transition-shadow">
            Start <span className="hidden sm:inline">Your Free IELTS Check</span> Now
            <ArrowRight />
          </Button>

          <p className="text-sm text-muted-foreground">No credit card required • Instant results • Unlimited checks</p>
        </div>
      </div>
