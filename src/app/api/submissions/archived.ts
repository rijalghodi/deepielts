...
// import { aiScore } from "@/lib/openai/openai";
// import {
...
//     // const prompt = getScoreParsePrompt({ scoreJson: "{}" });
//     const prompt = getModelEssayPrompt({
//       taskType: "ielts-writing-task-2",
//       question:
//         "Some people believe that students should be taught academic knowledge so that they can pass exams, and not be taught skills such as cooking or dressing. To what extent do you agree or disagree?",
//       answer:
//         "Many people think that schools should only focus on academic subjects and ignore practical skills like cooking or dressing. I partly agree with this idea because academic knowledge is important for exams and future jobs, but practical skills are also useful in daily life.",
//       attachment: "Null",
//     });
//     return NextResponse.json(new AppResponse({ data: prompt }));

//     // const body = await req.json();
//     // const data = createSubmissionBodySchema.parse(body);

//     // const stream = await aiScore(data);
...
//     //       }
//     //     } finally {
//     //       // ✅ Save to DB here (after streaming ends)
//     //       //  await saveToDB({ prompt, response: fullResponse });
